...
* Accuracy of the two base models could be improved by ~65% and ~20% percent respectively, while it should be mentioned that the second base model already had an accuracy of nearly 80% at the start.  
